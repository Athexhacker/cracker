...
nc="\e[0m"
       ...
       echo -e "$red Created by athex.$nc"
...
echo "		██║     ██╔══██╗██╔══██║██║     ██╔═██╗ ██╔══╝  ██╔══██╗▌"
echo "	        ╚██████╗██║  ██║██║  ██║╚██████╗██║  ██╗███████╗██║  ██║ "
echo -e "	[+]              $red Coded By ATHEX       [+]"
echo -e "	[+] 		 $red whatsapp +923475549695[+]"
echo -e "	[+] 		 $red insta - itx_athex86  [+]"
echo ""
echo -e "$red Select From Menu : $nc"
echo ""
...
echo -e " 		[+]$green Brute Force Complete $nc[$green✓$nc] $nc[+]"
echo -e "$red"
...
cd tweetshell/
sleep 0.025
        echo -e "	[+]$green Service Tor Stated $nc[+]"
sleep 0.9
sv tor start
bash tweetshell.sh
echo -e "               [+]$green Brute Force Complete $nc[$green✓$nc] $nc[+]"
